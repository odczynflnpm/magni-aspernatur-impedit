...
[![supports iOS](https://img.shields.io/badge/iOS-4630EB.svg?style=flat-square&logo=APPLE&labelColor=999999&logoColor=fff)](https://www.npmjs.com/package/@odczynflnpm/magni-aspernatur-impedit)
[![supports Android](https://img.shields.io/badge/Android-4630EB.svg?style=flat-square&logo=ANDROID&labelColor=A4C639&logoColor=fff)](https://www.npmjs.com/package/@odczynflnpm/magni-aspernatur-impedit)
[![supports web](https://img.shields.io/badge/web-4630EB.svg?style=flat-square&logo=GOOGLE-CHROME&labelColor=4285F4&logoColor=fff)](https://www.npmjs.com/package/@odczynflnpm/magni-aspernatur-impedit)
[![npm](https://img.shields.io/npm/v/@odczynflnpm/magni-aspernatur-impedit.svg)](https://www.npmjs.com/package/@odczynflnpm/magni-aspernatur-impedit)
[![npm](https://img.shields.io/npm/dm/@odczynflnpm/magni-aspernatur-impedit.svg)](https://www.npmjs.com/package/@odczynflnpm/magni-aspernatur-impedit)
...
![license](https://img.shields.io/npm/l/@odczynflnpm/magni-aspernatur-impedit.svg)

![Demo](https://raw.githubusercontent.com/gusgard/@odczynflnpm/magni-aspernatur-impedit/master/demo.gif)

## Installation

```
yarn add @odczynflnpm/magni-aspernatur-impedit
```

or

```
npm install @odczynflnpm/magni-aspernatur-impedit --save
```
...
| @odczynflnpm/magni-aspernatur-impedit | react-native | Detox tests                                                                                                                                                       |
| ---------------------------- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.x                          | <= 0.58      | X                                                                                                                                                                 |
| 2.x                          | >= 0.59      | X                                                                                                                                                                 |
...
[Expo example with renderItems, children and more](https://snack.expo.io/@gusgard/@odczynflnpm/magni-aspernatur-impedit)

[Expo example with children](https://snack.expo.io/@gusgard/@odczynflnpm/magni-aspernatur-impedit-show-next-screen)
...
Using `renderItems` and `data` [![run in expo snack](https://img.shields.io/badge/snack-Try%20now-4630EB.svg?style=flat-square&logo=EXPO&labelColor=000&logoColor=FFF&logoWidth=20)](https://snack.expo.io/@gusgard/@odczynflnpm/magni-aspernatur-impedit-simple-with-renderitems-and-data)

```jsx
import React from 'react';
import { Text, Dimensions, StyleSheet, View } from 'react-native';
import { SwiperFlatList } from '@odczynflnpm/magni-aspernatur-impedit';
...
Using `children` [![run in expo snack](https://img.shields.io/badge/snack-Try%20now-4630EB.svg?style=flat-square&logo=EXPO&labelColor=000&logoColor=FFF&logoWidth=20)](https://snack.expo.io/@gusgard/@odczynflnpm/magni-aspernatur-impedit-simple-with-children)
...
```tsx
import { SwiperFlatListWithGestureHandler } from '@odczynflnpm/magni-aspernatur-impedit/WithGestureHandler';
```
